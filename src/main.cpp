...
const string strMessageMagic = "Tradebits Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    return nSubsidy + nFees + MIN_RELAY_TX_FEE;
}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tradebits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tradebits is the next big thing";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x04eedbc512a7766ec5e420e024d6bf1a9bb57770ad850ad3cabde0ab6f01032e"));
        block.print();
